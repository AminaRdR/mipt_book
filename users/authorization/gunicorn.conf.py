...
bind = '0.0.0.0:' + environ.get('PORT', '8088')  # Привязка к порту
...
name = 'authorization'  # Имя приложения

# Дополнительные настройки

env = {
    'DJANGO_SETTINGS_MODULE': 'authorization.settings' # Путь к вашим Django-настройкам
}
