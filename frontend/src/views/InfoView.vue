...
<template>
    ...
    <main>
        ...
        <section id="system">
            ...
            <p>
               При наличии высокой загруженности аудиторий вы можете выставить Число
	       ББ самостоятельно или автоматически. В случае выставления ББ самостоятельно 
	       вы отправляете свою заявку на аукцион, в котором N заявок соревнуются
	       за M мест бронирования. В случае автоматического выставления баллов
	       бронирования система подбирает наименьшее число ББ, требуемых для наиболее
	       вероятного бронирования аудитории. Система автоматических баллов бронирования настроена на 90% шанс бронирования аудитории.  
            </p>
